...
public class DepthFirstSearchTest {
    ...
    @Test
    public void dfsShouldBeEmptyForEmptyGraph() {
        Graph graph = new AdjacencyListDirectedGraph(0);

        assertThat(dfs.dfs(graph), is(emptyIterable()));
    }
    ...
    public void dfsShouldTraverseVerticesInStraightOrderForDisjointGraph(int vertices) {
        Graph graph = new AdjacencyMatrixUndirectedGraph(vertices);

        assertThat(dfs.dfs(graph),
    ...
    public void bfsShouldTravers(Graph graph, List<Integer> traversal) {
        assertThat(dfs.dfs(graph), is(traversal));
    }
    ...
    private Object[][] directedGraphs() {
        ...
        return new Object[][]{
                ...
                {digraphOfFour, Arrays.asList(0, 3, 1, 2)},
                {digraphOfSeven, Arrays.asList(0, 6, 4, 5, 3, 2, 1)}
        };
    }
    ...
    private Object[][] undirectedGraphs() {
        ...
        return new Object[][]{
                ...
                {graphOfSeven, Arrays.asList(0, 5, 3, 2, 6, 4, 1)}
        };
    }
